...
class oigCallControlClient extends EventEmitter {
  ...
  _execute(params, callback, methodName, paramsTemplate, resultTemplate) {
    ...
    //console.log(`[_soap_client] params=${JSON.stringify(params)}`);//KEVIN
    // Standard params & callback processing
    var p = _this._parameters(params, callback);
    ...
    return _this._soap_client[methodName + "Async"](soapParams).then(
      function(result) {
        // TODO: debug only
        ...
        //console.log(`*[_soap_client]result=${JSON.stringify(result)}`); //KEVIN
